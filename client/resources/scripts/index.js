...
function handleEditClick(){
    makeEditable();
    hideButtons();
    var buttonHtml = "<button class=\"btn btn-primary btn-large \" onclick=\"handleEditSave("+myBook.id+")\">Save</button>"
...
function handleNewClick(){
    ...
    hideButtons();
    blankFields();
    var buttonHtml = "<button class=\"btn btn-primary btn-large \" onclick=\"handleNewSave()\">Save</button>"
    buttonHtml += "<button class=\"btn btn-warning btn-large btn-cancel \" onclick=\"handleCancelSave()\">Cancel</button>"
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
...
function blankFields(){
    ...
    var html = "<img class = \"coverArt\" src =\"\"></img>"
    document.getElementById("picBox").innerHTML = html;
}
